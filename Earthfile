...
netboot:
    ...
    # TODO: why do the kernel and initrd files don't have an extension?
    ...
    # TODO: what is the different between this one and the ipxe.iso.ipxe one?
