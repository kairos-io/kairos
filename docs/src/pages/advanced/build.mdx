...
Note, in order to use the image with QEMU, we need to resize the disk at least to 32GB, this can be done via CRD by setting `diskSize: 32000` or by truncating the file after downloading:
