...
var (
	...
	// Using apimachinery's SchemeBuilder here keeps this API package free of
	// the controller-runtime dependency; see the deprecation note on
...
func addKnownTypes(scheme *runtime.Scheme) error {
	scheme.AddKnownTypes(GroupVersion, &SealedVolume{}, &SealedVolumeList{})
